	...
	vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"description" => wp_kses(__("Please set an icon. The entire list of icons can be found at <a href='https://fontawesome.com/icons' target='_blank'>FontAwesome project page</a>.", "houzez"), $allowed_html_array),
