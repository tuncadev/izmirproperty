...
class HOUZEZ_property_taxonomies extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $item_number = isset($instance['item_number']) ? $instance['item_number'] : 20;
        ...
        echo '<div class="widget-body">';
            houzez_property_taxonomies( $prop_taxonomy, $show_child, $show_count, $item_number );
        echo '</div>';
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['item_number'] = $new_instance['item_number'];
...
function houzez_property_taxonomies( $taxonomy, $show_child, $show_count, $item_number ) {
    ...
    $terms = get_terms( $taxonomy , array( 'parent'=> 0, 'number' => $item_number, 'orderby' => 'count', 'order' => 'DESC' ));
