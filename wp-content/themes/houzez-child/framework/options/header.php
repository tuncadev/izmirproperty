...
Redux::setSection( $houzez_opt_name, array(
    'title'            => esc_html__( 'Headers', 'houzez-child' ),
    'id'               => 'headers',
    'desc'             => '',
...
Redux::setSection( $houzez_opt_name, array(
    'title'            => esc_html__( 'Style', 'houzez-child' ),
    'id'               => 'header-styles',
    'subsection'       => true,
    'desc'             => '',
    'fields'           => array(
        array(
            'id'       => 'header_style',
            'type'     => 'image_select',
            'title'    => esc_html__( 'Header Style', 'houzez-child' ),
            'subtitle' => '',
        ...
        array(
            ...
            'desc'     => esc_html__( 'Select the header layout', 'houzez-child' ),
        ...
        array(
            ...
            'type'     => 'text',
            'required' => array('header_style', '=', '5'),
            'title'    => esc_html__( 'Header Width', 'houzez-child' ),
            'subtitle' => '',
            'default'    => '1170',
            'validate' => 'numeric',
        ),
        ...
        array(
            ...
            'type'     => 'text',
            'required' => array('header_style', '=', '1'),
            'title'    => esc_html__( 'Header Height', 'houzez-child' ),
            'subtitle' => '',
            'default'    => '60',
            'validate' => 'numeric',
        ),
        ...
        array(
            ...
            'title'    => esc_html__( 'Header Top Height', 'houzez-child' ),
            'subtitle' => '',
            'default'    => '80',
            'validate' => 'numeric',
        ),
        ...
        array(
            ...
            'type'     => 'text',
            'required' => array('header_style', '=', '3'),
            'title'    => esc_html__( 'Header Bottom Height', 'houzez-child' ),
            'subtitle' => '',
            'default'    => '54',
            'validate' => 'numeric',
        ),
        ...
        array(
            'id'       => 'main-menu-sticky',
            'type'     => 'switch',
            'title'    => esc_html__( 'Sticky Menu - Desktop Devices', 'houzez-child' ),
            'desc' => esc_html__( 'Enable or disable the sticky menu on desktop devices', 'houzez-child' ),
            'default'  => 0,
        ...
        array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__( 'Enable or disable phone numder for header 1 & 4', 'houzez-child' ),
            'required' => array( 
        ...
        array(
            ...
            'subtitle' => esc_html__( 'Call us number in header', 'houzez-child' ),
            'indent'   => true, // Indent all options below until the next 'section' option is set.
        ),
        array(
            'id'       => 'hd3_callus',
            'type'     => 'switch',
            'title'    => esc_html__( 'Enable or disable the call us box in the header', 'houzez-child' ),
            'desc'     => '',
            'subtitle' => '',
            'default'  => 1,
            'on'       => esc_html__( 'Enabled', 'houzez-child' ),
        ...
        array(
            ...
            'subtitle' => esc_html__('Recommended size 85 x 85', 'houzez-child'),
            'default'	=> array(
        ...
        array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__( 'Contact Information', 'houzez-child' ),
            'desc'     => esc_html__( 'Enable or disable the contact information', 'houzez-child' ),
            'subtitle' => '',
            'default'  => 1,
            'on'       => esc_html__( 'Enabled', 'houzez-child' ),
            'off'      => esc_html__( 'Disabled', 'houzez-child' ),
        ...
        array(
            ...
            'desc'     => esc_html__( 'Enter the email address', 'houzez-child' ),
        ),
        array(
        ...
        array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__( 'Address', 'houzez-child' ),
            'desc'     => esc_html__( 'Enable or disable the address', 'houzez-child' ),
            'subtitle' => '',
            'default'  => 1,
            'on'       => esc_html__( 'Enabled', 'houzez-child' ),
            'off'      => esc_html__( 'Disabled', 'houzez-child' ),
        ...
        array(
            ...
            'title'    => esc_html__( 'Line 1', 'houzez-child' ),
            'subtitle' => '',
            'default'	=> 'Oceanview Hall',
            'desc'     => esc_html__( 'Enter the address line 1', 'houzez-child' ),
        ),
        array(
            'id'       => 'hd2_address_line2',
            'type'     => 'text',
            'required' => array('hd2_address_info', '=', '1'),
            'title'    => esc_html__( 'Line 2', 'houzez-child' ),
            'subtitle' => '',
            'default'	=> 'Miami, FL 33141',
            'desc'     => esc_html__( 'Enter the address line 2', 'houzez-child' ),
        ),
        array(
        ...
        array(
            ...
            'type'     => 'section',
            'required' => array('header_style', '=', '2'),
            'title'    => esc_html__( 'Office Timing', 'houzez-child' ),
            'subtitle' => '',
            'indent'   => true,
        ),
        array(
            ...
            'on'       => esc_html__( 'Enabled', 'houzez-child' ),
            'off'      => esc_html__( 'Disabled', 'houzez-child' ),
            'desc'     => esc_html__( 'Enable or disable the office time', 'houzez-child' ),
        ),
        array(
            'id'       => 'hd2_timing_hours',
            'type'     => 'text',
            'required' => array('hd2_timing_info', '=', '1'),
            'title'    => esc_html__( 'Opening Hours', 'houzez-child' ),
            'subtitle' => '',
            'default'	=> '9 am to 6 pm',
            'desc'     => esc_html__( 'Enter the opening hours', 'houzez-child' ),
        ...
        array(
            ...
            'type'     => 'text',
            'required' => array('hd2_timing_info', '=', '1'),
            'title'    => esc_html__( 'Opening Days', 'houzez-child' ),
            'subtitle' => '',
            'default'	=> 'Monday to Friday',
            'desc'     => esc_html__( 'Enter the opening days', 'houzez-child' ),
        ),
        array(
...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'           => array(
        array(
            ...
            'subtitle' => esc_html__('Only for header style 2, 3 and the top bar', 'houzez-child'),
            'desc'     => esc_html__( 'Enable or disable the social media in the header', 'houzez-child' ),
            'default'  => 0,
            'on'       => esc_html__( 'Enabled', 'houzez-child' ),
            'off'      => esc_html__( 'Disabled', 'houzez-child' ),
        ),
        ...
        array(
            ...
            'desc' => esc_html__( 'Enter the Pinterest profile URL', 'houzez-child' ),
            'default'  => false,
        ),
        array(
            'id'       => 'hs-youtube',
            ...
            'desc' => esc_html__( 'Enter the Youtube profile URL', 'houzez-child' ),
            'default'  => false,
        ),
        array(
            'id'       => 'hs-yelp',
            ...
            'desc' => esc_html__( 'Enter the Yelp profile URL', 'houzez-child' ),
            'default'  => false,
        ),
        array(
            'id'       => 'hs-behance',
            ...
            'desc' => esc_html__( 'Enter the Behance profile URL', 'houzez-child' ),
            'default'  => false,
        ),
        array(
            'id'       => 'hs-whatsapp',
...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'           => array(
        array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__( 'Create Listing Button', 'houzez-child' ),
            'desc' => esc_html__('Enable or disable the Create Listing button on the header', 'houzez-child'),
            'default'  => 1,
            'on'       => esc_html__( 'Enabled', 'houzez-child' ),
            'off'      => esc_html__( 'Disabled', 'houzez-child' ),
        ),
        array(
            ...
            'type'     => 'select',
            'title'    => esc_html__( 'Button Behavior', 'houzez-child' ),
            'desc' => esc_html__('Is the login required to create a new listing?', 'houzez-child'),
            'default'  => 'no',
            'options'  => array(
        ...
        array(
            ...
            'subtitle' => esc_html__('Enable or disable custom link for create listing button ', 'houzez-child'),
            'default'  => 0,
            'on'       => esc_html__( 'Enabled', 'houzez-child' ),
            'off'      => esc_html__( 'Disabled', 'houzez-child' ),
        ...
        array(
            ...
            'type'     => 'text',
            'title'    => esc_html__('Add Link', 'houzez-child'),
            'subtitle' => esc_html__('Enter link. Ex: http://website.com/pagelink ', 'houzez-child'),
            'default'  => '',
        ...
        array(
            ...
            'type'     => 'text',
            'title'    => esc_html__('Custom Title', 'houzez-child'),
            'subtitle' => '',
            'default'  => '',
            'required' => array('custom_create_lisiting_btn', '=', '1')
        ),
