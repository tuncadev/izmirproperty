...
Redux::setSection( $houzez_opt_name, array(
    'title'  => esc_html__( 'General', 'houzez-child' ),
    'id'     => 'general-options',
    'desc'   => '',
    ...
    'fields'        => array(
        ...
        array(
            ...
            'type'     => 'button_set',
            'title'    => esc_html__('Site Container Width', 'houzez-child'),
            'subtitle' => esc_html__('Select website container width.', 'houzez-child'),
            'options' => array(
                '1210px' => '1170px',
                '1310px' => '1270px',
                '1410px' => '1370px',
        ...
        array(
            'id'       => 'backtotop',
            'type'     => 'switch',
            'title'    => esc_html__( 'Back to Top', 'houzez-child' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Show back to top button', 'houzez-child' ),
            'default'  => 1,
        ...
        array(
            'id'       => 'add_to_favorite',
            'type'     => 'switch',
            'title'    => esc_html__( 'Add to favorites', 'houzez-child' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Login required for add to favorites?', 'houzez-child' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez-child' ),
            'off'      => esc_html__( 'No', 'houzez-child' ), 
        ),
        array(
            'id'       => 'site_breadcrumb',
            'type'     => 'switch',
            'title'    => esc_html__( 'Breadcrumb?', 'houzez-child' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Show breadcrumb', 'houzez-child' ),
            'default'  => 1,
            'on'       => esc_html__( 'Yes', 'houzez-child' ),
            'off'      => esc_html__( 'No', 'houzez-child' ), 
        ),
        array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__( 'Phone/Mobile Number', 'houzez-child' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Show full phone number for agents, agencies across the site.', 'houzez-child' ),
            'default'  => 1,
            'on'       => esc_html__( 'Yes', 'houzez-child' ),
            'off'      => esc_html__( 'No', 'houzez-child' ), 
        ),
        array(
            'id'       => 'gallery_caption',
            'type'     => 'switch',
            'title'    => esc_html__( 'Gallery Image Caption?', 'houzez-child' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Show image caption for property detail page gallery?', 'houzez-child' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez-child' ),
            'off'      => esc_html__( 'No', 'houzez-child' ),
        ),
        array(
            'id'       => 'lightbox_caption',
            'type'     => 'switch',
            'title'    => esc_html__( 'Popup Gallery Image Caption?', 'houzez-child' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Show image caption for popup gallery?', 'houzez-child' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez-child' ),
            'off'      => esc_html__( 'No', 'houzez-child' ),
        ),
        ...
        array(
            ...
            'type'      => 'select',
            'title'     => esc_html__( 'Language for datepicker', 'houzez-child' ),
            'subtitle'  => esc_html__( 'This applies for the calendar field type available for properties.', 'houzez-child' ),
        ...
        /*array(
            ...
            'subtitle'  => esc_html__( 'Select default country', 'houzez-child' ),
            'options'   => $Countries,
            'default' => 'US'
        ),*/
        ...
        array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__( 'Block Users Admin Access?', 'houzez-child' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Restrict user admin panel access', 'houzez-child' ),
            'default'  => 1,
            'on'       => esc_html__( 'Yes', 'houzez-child' ),
            'off'      => esc_html__( 'No', 'houzez-child' ),
        ),
        ...
        array(
            ...
            'type'     => 'select',
            'multi'    => true,
            'title'    => esc_html__('Templates', 'houzez-child'),
            'subtitle' => esc_html__('Select templates which you want to remove from template list when add new page', 'houzez-child'),
            'options' => array(
        ...
        array(
            ...
            'type'     => 'select',
            'multi'    => true,
            'title'    => esc_html__('Page Filters', 'houzez-child'),
            'subtitle' => esc_html__('Select which taxonomy filters you want to remove when add new page in admin panel.', 'houzez-child'),
            'options' => array(
                'property_type' => esc_html__('Types', 'houzez-child'),
                'property_status' => esc_html__('Statuses', 'houzez-child'),
                'property_city' => esc_html__('Cities', 'houzez-child'),
                'property_area' => esc_html__('Areas', 'houzez-child'),
                'property_states' => esc_html__('States', 'houzez-child'),
                'property_feature' => esc_html__('Features', 'houzez-child'),
                'property_label' => esc_html__('Labels', 'houzez-child')
            )
        ),
        ...
        array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__( 'Measurement Unit Globally', 'houzez-child' ),
            'subtitle' => esc_html__( 'Enable/Disable property measurement unit globally, it will overwrite measurement unit added for single properties', 'houzez-child' ),
            'default'  => 0,
        ...
        array(
            'id'        => 'measurement_unit',
            'type'      => 'select',
            'title'     => esc_html__( 'Measurement Unit', 'houzez-child' ),
            'subtitle'  => esc_html__( 'Select the measurement unit you will use on the website', 'houzez-child' ),
        ...
        array(
            ...
            'type'      => 'text',
            'title'     => esc_html__( 'Square Feet Text', 'houzez-child' ),
            'subtitle'  => esc_html__( 'Enter text for square feet', 'houzez-child' ),
            'default' => 'sqft'
        ),
        array(
            'id'        => 'measurement_unit_square_meter_text',
            'type'      => 'text',
            'title'     => esc_html__( 'Square Meters Text', 'houzez-child' ),
            'subtitle'  => esc_html__( 'Enter text for square meters', 'houzez-child' ),
            'default' => 'm²'
        ),
        ...
        array(
            'id'       => 'site_scroll_top',
            'type'     => 'switch',
            'title'    => esc_html__( 'Scroll To Top?', 'houzez-child' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Enable/Disable Scroll to top', 'houzez-child' ),
            'default'  => 1,
            'on'       => esc_html__( 'Enabled', 'houzez-child' ),
            'off'      => esc_html__( 'Disabled', 'houzez-child' ),
        ),*/
        array(
            'id'       => 'sticky_sidebar',
            'type'     => 'checkbox',
            'title'    => esc_html__( 'Sticky Sidebar', 'houzez-child' ),
            'desc'     => '',
            'subtitle'     => esc_html__('Select in which page templates you want the sidebars to be sticky', 'houzez-child'),
            'options'  => array(
                'default_sidebar' => esc_html__('Default Page Template (Blog)', 'houzez-child'),
                'property_listings' => esc_html__('Listing Page', 'houzez-child'),
                'single_property' => esc_html__('Property Detail Page', 'houzez-child'),
                'agent_sidebar' => esc_html__('Agent Profile Page', 'houzez-child'),
                'agency_sidebar' => esc_html__('Agency Profile Page', 'houzez-child'),
                'search_sidebar' => esc_html__('Search Result Page', 'houzez-child'),
                'page_sidebar' => esc_html__('Page Template', 'houzez-child')
            ),
            'default' => array(
                'default_sidebar' => '0',
                'property_listings' => '1',
